  ...
  return (
    <div className={styles.burgerOpen}>
      ...
      <div className={styles.githubParent}>
        <img className={styles.githubIcon} alt="" src="../github5.svg" />
        <img className={styles.githubIcon} alt="" src="../dribble5.svg" />
        <img className={styles.githubIcon} alt="" src="../figma5.svg" />
      </div>
    </div>
  );
};

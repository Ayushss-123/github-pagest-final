...
const SkillsContainer: FunctionComponent = () => {
  return (
    <div className={styles.skills}>
      ...
      <div className={styles.blockParent}>
        ...
        <div className={styles.frameContainer}>
          <div className={styles.languagesWrapper}>
            <div className={styles.languages}>Databases</div>
          </div>
          <div className={styles.blockChild} />
          <div className={styles.frameGroup}>
            <div className={styles.typescriptParent}>
        ...
        <div className={styles.frameParent1}>
          <div className={styles.languagesWrapper}>
            <div className={styles.languages}>Frameworks</div>
          </div>
          <div className={styles.blockChild} />
          <div className={styles.frameGroup}>
            <div className={styles.typescriptParent}>
        ...
        <div className={styles.frameParent3}>
          <div className={styles.languagesWrapper}>
            <div className={styles.languages}>Other</div>
          </div>
          <div className={styles.blockChild} />
          <div className={styles.frameGroup}>
            <div className={styles.typescriptParent}>
        ...
        <div className={styles.frameParent5}>
          <div className={styles.languagesWrapper}>
            <div className={styles.languages}>Tools</div>
          </div>
          <div className={styles.blockChild} />
          <div className={styles.frameGroup}>
            <div className={styles.typescriptParent}>
